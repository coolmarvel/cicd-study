...
import { ENUM_REQUEST_METHOD } from 'src/common/request/constant/request.enum.constant';
...
export default registerAs(
  ...
  (): Record<string, any> => ({
    ...
    cors: {
      allowMethod: [ENUM_REQUEST_METHOD.GET, ENUM_REQUEST_METHOD.DELETE, ENUM_REQUEST_METHOD.PUT, ENUM_REQUEST_METHOD.PATCH, ENUM_REQUEST_METHOD.POST],
