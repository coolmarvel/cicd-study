...
export abstract class DatabaseBaseRepositoryAbstract<Entity = any> {
  ...
  abstract findAllDistinct<T = Entity>(fieldDistinct: string, find?: Record<string, any>, options?: IDatabaseFindAllOptions<any>): Promise<T[]>;
  ...
  abstract findOneAndLock<T = Entity>(find: Record<string, any>, options?: IDatabaseFindOneLockOptions<any>): Promise<T>;

  abstract findOneByIdAndLock<T = Entity>(_id: string, options?: IDatabaseFindOneLockOptions<any>): Promise<T>;
