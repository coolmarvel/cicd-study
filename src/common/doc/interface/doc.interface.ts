...
import { ENUM_DOC_REQUEST_BODY_TYPE } from 'src/common/doc/constant/doc.enum.constant';
import { ENUM_FILE_MIME } from 'src/common/file/constant/file.enum.constant';
...
export interface IDocResponseFileOptions extends Omit<IDocResponseOptions<any>, 'serialization' | 'statusCode'> {
