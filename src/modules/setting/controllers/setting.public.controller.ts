...
import { FILE_SIZE_IN_BYTES, FILE_SIZE_LARGE_IN_BYTES, FILE_SIZE_MEDIUM_IN_BYTES } from 'src/common/file/constants/file.constant';
...
export class SettingPublicController {
  ...
  @Response('setting.core', { serialization: SettingCoreSerialization })
  ...
  async getUserMaxCertificate(): Promise<IResponse> {
    ...
    const timezone: SettingTimezoneSerialization = { timezone: tz, timezoneOffset: timezoneOffset };
    ...
    return { data: { languages, file, timezone } };
  }
}
