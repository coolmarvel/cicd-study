...
export interface IRoleService {
  ...
  update(repository: RoleDoc, data: RoleUpdateDto, options?: IDatabaseSaveOptions): Promise<RoleDoc>;
  updatePermissions(repository: RoleDoc, data: RoleUpdatePermissionDto, options?: IDatabaseSaveOptions): Promise<RoleDoc>;
