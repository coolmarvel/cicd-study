...
export interface IUserService {
  ...
  updatePasswordAttempt(repository: UserDoc, { passwordAttempt }: UserUpdatePasswordAttemptDto, options?: IDatabaseSaveOptions): Promise<UserDoc>;
  ...
  existByEmails(emails: string[], options?: IDatabaseExistOptions): Promise<boolean>;
  existByMobileNumbers(mobileNumbers: string[], options?: IDatabaseExistOptions): Promise<boolean>;
}
