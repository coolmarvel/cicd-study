...
export class UserPublicController {
  ...
  @Post('/sign-up')
  async signUp(@Body() { email, mobileNumber, ...body }: UserSignUpDto): Promise<void> {
    ...
    const user: UserDoc = await this.userService.create({ email, mobileNumber, signUpFrom: ENUM_USER_SIGN_UP_FROM.PUBLIC, role: role._id, ...body }, password);
